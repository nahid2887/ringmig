...
# Allow larger profile/media uploads through Django before request parsing rejects them.
...
FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://www.ring-mig.com/')
FRONTEND_URL2 =  'https://www.ring-mig.com/dashboard/talker'
